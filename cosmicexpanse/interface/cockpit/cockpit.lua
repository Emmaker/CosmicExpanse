...
function systemScreenState(system, warpIn)
  widget.setVisible("zoomOut", contains(player.shipUpgrades().capabilities, "systemTravel"))
  ...
  while true do
    ...
    local zoomOut = (vec2.mag(View:toSystem(View:mousePosition())) - 20 > (View.settings.viewRadius) / View.systemCamera.scale) and contains(player.shipUpgrades().capabilities, "systemTravel")
    if zoomOut then
